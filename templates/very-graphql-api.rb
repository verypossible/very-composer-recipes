...
@recipes = ["bin_scripts", "database", "devise_token_auth", "graphql", "procfile", "performance_evaluation", "production_gems", "puma", "dotenv", "derailed", "rack_mini_profiler", "stackprof", "rack_canonical_host", "sass_setup", "bullet", "cors", "rollbar", "bourbon", "spring_commands_rspec"]
@prefs = {}
@gems = []
...
# >-------------------------- templates/recipe.erb ---------------------------start<
# >--------------------------------[ GraphQL ]--------------------------------<
@current_recipe = "graphql"
@before_configs["graphql"].call if @before_configs["graphql"]
say_recipe 'GraphQL'
@configs[@current_recipe] = config
# >--------------------------- recipes/GraphQL.rb ----------------------------start<
